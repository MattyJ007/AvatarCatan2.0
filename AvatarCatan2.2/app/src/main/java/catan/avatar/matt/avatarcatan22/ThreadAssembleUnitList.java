...
public class ThreadAssembleUnitList extends Thread {
    ...
    private static String[] units = {"Fire Nation Guy,fng,8,Town (Earth),5,4,1,0,3,0,8,2,1,Taunt",
            ...
            "Lesser Spirit,les,14,Summoned by Jinora or Guru Pathik,12,8,1,15,6,7,15,8,0,none",
            ...
            "Spirit Wan Shi Tong,wst,14,Village (Earth) on Dessert Tile & Knowledge Spirit Card ,10,15,1,0,7,10,30,12,1,none",
            ...
            "Spirit,spi,14,Spirit Defender Card,13,12,2,20,9,8,23,15,0,none",
            ...
            "Spirit Hei Bai ,hei,14,Village containing a spirit portal & Hei Bai Assist Card,20,15,1,10,8,7,30,21,1,Removes One Unit at the beginning of a battle - unit is returned if Hei Bai is defeated",
            ...
            "Spirit Face Stealer Koh,koh,14,Spirit Portal Open & Koh Assist Card,30,13,1,60,6,7,40,35,1,none",
            "Avatar Roku,rok,15,3 Settlements (Air + Earth+Water) & (Fire Nation Capital or Ember Island),27,20,2,15,12,8,28,35,1,none",
            "Avatar Aang,aan,15,3 Settlements (Air + Earth+ Fire) & (Southern Air Temple or Southern Water Tribe),26,20,3,20,15,8,30,38,1,Redirect Lightning",
