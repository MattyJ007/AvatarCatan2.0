...
public class ThreadAssembleUnitList extends Thread {
    ...
    private static String[] units = {"Fire Nation Guy,fng,8,Town (Earth),5,4,1,0,3,0,8,2,1,Taunt",
            ...
            "Guru Pathik,pat,0,Air Temple,6,9,1,0,9,10,10,17,1,Summon Spirit",
            ...
            "Jinora,jin,11,City,5,12,2,0,8,8,10,19,1,Summon Spirit",
            ...
            "Spirit Hei Bai ,hei,14,Village containing a spirit portal & Hei Bai Assist Card,20,15,1,10,8,7,30,0,1,Kidnap",
